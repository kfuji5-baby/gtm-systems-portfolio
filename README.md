...
Representative portfolio-safe code:

- [`CustomerMasterCockpitController.cls`](CustomerMasterCockpitController.cls)
- [`customerMasterCockpit.js`](customerMasterCockpit.js)
- [`customerMasterCockpit.html`](customerMasterCockpit.html)
...
These figures refer to target-org validation and test pass rate, not 100% code coverage. See [`validation-notes.md`](validation-notes.md).
...
├── inboundLeadParser.js
├── matchingEngine.js
├── salesforceSync.js
├── prospectScoring.apex
├── sample-output.json
├── sanitized-inquiry.txt
└── LICENSE-NOTICE.md
```
